...
describe('Error Handler Middleware', () => {
  ...
  describe('errorHandler', () => {
    test('should handle JSON parsing errors', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Unhandled error:', jsonError);
    ...
    test('should handle errors without message property', () => {
      ...
      expect(mockJson).toHaveBeenCalledWith({
        success: false,
        error: 'Internal server error',
        message: process.env.NODE_ENV === 'production' ? 'Something went wrong' : undefined
      });
    });
    ...
    test('should handle string errors', () => {
      ...
      expect(mockJson).toHaveBeenCalledWith({
        success: false,
        error: 'Internal server error',
        message: process.env.NODE_ENV === 'production' ? 'Something went wrong' : stringError
      });
    });
    ...
    test('should handle errors with custom status codes', () => {
      ...
      expect(mockJson).toHaveBeenCalledWith({
        success: false,
        error: 'Internal server error',
        message: process.env.NODE_ENV === 'production' ? 'Something went wrong' : 'Forbidden'
      });
    });
  });
